    ...
    prompt = ChatPromptTemplate.from_messages(
        [
            (
                ...
                dedent(
                    """
                    Ты помогаешь готовить научно-популярные статьи.
    ...
    prompt = ChatPromptTemplate.from_messages(
        [
            (
                ...
                dedent(
                    """
                    Ты создаёшь подробный и логичный план научно-популярной статьи.
    ...
    prompt = ChatPromptTemplate.from_messages(
        [
            (
                ...
                dedent(
                    """
                    Ты пишешь полный черновик научно-популярной статьи.
